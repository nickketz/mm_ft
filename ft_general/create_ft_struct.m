...
for sub = 1:length(exper.subjects)
  for ses = 1:length(exper.sessions)
    ...
    elseif ~strcmpi(exper.eegFileExt,'set') && ~isempty(eventValuesToProcess)
      ...
      [ft_raw,badChan,badEv] = feval(str2func(ana.segFxn),fullfile(dirs.dataroot,dirs.dataDir),exper.subjects{sub},exper.sessions{ses},1,eventValuesToProcess,eventValuesToProcess_orig,exper.prepost,files.elecfile,ana,exper,dirs);
